...
class _MyAppState extends State<MyApp> {
  ...
  List<String> images = [
    // "wallpaper01.gif",
    // "wallpaper02.jpg"
    "https://cdn.pixabay.com/photo/2019/12/31/05/54/quokka-4731259_960_720.jpg",
            ...
            child: Column(
              children: <Widget>[
                downloading
                    ? imageDownloadDialog()
                    // : Image.asset(
                    //     'assets/wallpaper/${images[nextImageID]}',
                    //     fit: BoxFit.fitWidth,
                    //   ),
                    : Image.network(
                        images[nextImageID],
                ...
                ElevatedButton(
                  onPressed: _isDisable
                      ...
                      : () async {
                          ...
                          home = await Wallpaper.homeScreen(options: RequestSizeOptions.RESIZE_FIT, width: width, height: height);
                          setState(() {
                            downloading = false;
                            home = home;
                          });
